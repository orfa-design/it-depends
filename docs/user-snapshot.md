...
DataArt дизайнер, mid-level. Використовує AI для базових задач —
ChatGPT для аналізу, написання текстів. Бачить колег (девелоперів,
більш просунутих дизайнерів) що роблять щось інакше: плагіни,
автоматизацію, живі продукти. Хоче теж, але не знає як підступитись
до цього рівня.
...
Вона вже всередині AI — просто на базовому рівні. Paralysis не про
"почати з нуля", а про перехід: casual user → power user. Бачить
що інші роблять щось якісно інше, розуміє що між "аналізую брифи"
і "будую плагін за 15 хвилин" — прірва. Не знає з чого цей перехід
починати.
